...
import { User, LogOut, ShoppingBag, UserCircle, UploadCloud } from 'lucide-react';
    ...
    if (success) {
      ...
      setRegisterPassword('');
       ...
       toast({
        ...
        description: 'Este email ya está en uso o la contraseña es demasiado débil.',
      });
    }
  }
          ...
          <TabsContent value="login">
            <form onSubmit={handleLogin}>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="login-password" text-align="right" className="text-right">
                    Contraseña
                  </Label>
                  <Input
                    id="login-password"
          ...
          <TabsContent value="register">
            <form onSubmit={handleRegister}>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="register-password" text-align="right" className="text-right">
                    Contraseña
                  </Label>
                  <Input
